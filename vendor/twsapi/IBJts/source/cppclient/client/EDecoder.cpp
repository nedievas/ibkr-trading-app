...
const char* EDecoder::processTickStringMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& value = tickStringProto.value();
...
const char* EDecoder::processOrderStatusMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& status = orderStatusProto.status();
	...
	const std::string& whyHeld = orderStatusProto.whyheld();
...
const char* EDecoder::processErrMsgMsg(const char* ptr, const char* endPtr) {
	...
	if (m_serverVersion >= MIN_SERVER_VER_ERROR_TIME) {
		DECODE_FIELD(errorTimeMs);
	}

	m_pEWrapper->error( id, errorTimeMs, errorCode, errorMsg, advancedOrderRejectJson);
...
const char* EDecoder::processErrorMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& errorMsg = errorMessageProto.errormsg();
	const std::string& advancedOrderRejectJson = errorMessageProto.advancedorderrejectjson();
	long long errorTimeMs = errorMessageProto.has_errortime() ? errorMessageProto.errortime() : 0;
...
const char* EDecoder::processAccountValueMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& key = accountValueProto.key();
	const std::string& value = accountValueProto.value();
	const std::string& currency = accountValueProto.currency();
	const std::string& accountName = accountValueProto.accountname();
...
const char* EDecoder::processPortfolioValueMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& accountName = portfolioValueProto.accountname();
...
const char* EDecoder::processAcctUpdateTimeMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& timeStamp = accountUpdateTimeProto.timestamp();
...
const char* EDecoder::processMarketDepthL2MsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	int position = marketDepthDataProto.has_position() ? marketDepthDataProto.position() : 0;
	const std::string& marketMaker = marketDepthDataProto.marketmaker();
	int operation = marketDepthDataProto.has_operation() ? marketDepthDataProto.operation() : 0;
	int side = marketDepthDataProto.has_side() ? marketDepthDataProto.side() : 0;
	double price = marketDepthDataProto.has_price() ? marketDepthDataProto.price() : 0;
	Decimal size = marketDepthDataProto.has_size() ? DecimalFunctions::stringToDecimal(marketDepthDataProto.size()) : UNSET_DECIMAL;
...
const char* EDecoder::processNewsBulletinMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& newsMessage = newsBulletinProto.newsmessage();
	const std::string& originExch = newsBulletinProto.originatingexch();
...
const char* EDecoder::processManagedAccountsMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& accountsList = managedAccountsProto.accountslist();
...
const char* EDecoder::processReceiveFAMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& xml = receiveFAProto.xml();
...
const char* EDecoder::processHistoricalDataEndMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& startDate = historicalDataEndProto.startdatestr();
	const std::string& endDate = historicalDataEndProto.enddatestr();
...
const char* EDecoder::processScannerDataMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	if (scannerDataProto.scannerdataelement_size() > 0) {
		for (int i = 0; i < scannerDataProto.scannerdataelement_size(); i++) {
			...
			const std::string& distance = element.distance();
			const std::string& benchmark = element.benchmark();
			const std::string& projection = element.projection();
			const std::string& comboKey = element.combokey();
...
const char* EDecoder::processScannerParametersMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& xml = scannerParametersProto.xml();
...
const char* EDecoder::processAccountDataEndMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& accountName = accountDataEndProto.accountname();
...
const char* EDecoder::processCommissionAndFeesReportMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	CommissionAndFeesReport commissionAndFeesReport;
	commissionAndFeesReport.execId = commissionAndFeesReportProto.execid();
	...
	commissionAndFeesReport.currency = commissionAndFeesReportProto.currency();
...
const char* EDecoder::processPositionMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& account = positionProto.account();
...
const char* EDecoder::processAccountSummaryMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& account = accountSummaryProto.account();
	const std::string& tag = accountSummaryProto.tag();
	const std::string& value = accountSummaryProto.value();
	const std::string& currency = accountSummaryProto.currency();
...
const char* EDecoder::processVerifyMessageApiMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& apiData = verifyMessageApiProto.apidata();
...
const char* EDecoder::processVerifyCompletedMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& errorText = verifyCompletedProto.errortext();
...
const char* EDecoder::processDisplayGroupListMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& groups = displayGroupListProto.groups();
...
const char* EDecoder::processDisplayGroupUpdatedMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& contractInfo = displayGroupUpdatedProto.contractinfo();
...
const char* EDecoder::processPositionMultiMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& account = positionMultiProto.account();
	const std::string& modelCode = positionMultiProto.modelcode();
...
const char* EDecoder::processAccountUpdateMultiMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& account = accountUpdateMultiProto.account();
	const std::string& modelCode = accountUpdateMultiProto.modelcode();
	const std::string& key = accountUpdateMultiProto.key();
	const std::string& value = accountUpdateMultiProto.value();
	const std::string& currency = accountUpdateMultiProto.currency();
...
const char* EDecoder::processSecurityDefinitionOptionParameterMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& exchange = secDefOptParameterProto.exchange();
	int underlyingConId = secDefOptParameterProto.has_underlyingconid() ? secDefOptParameterProto.underlyingconid() : 0;
	const std::string& tradingClass = secDefOptParameterProto.tradingclass();
	const std::string& multiplier = secDefOptParameterProto.multiplier();
...
const char* EDecoder::processTickNewsMsg(const char* ptr, const char* endPtr)
{
	...
	DECODE_FIELD( tickerId);
	DECODE_FIELD(timeStampMs);
	DECODE_FIELD( providerCode);
	DECODE_FIELD( articleId);
	DECODE_FIELD( headline);
	DECODE_FIELD( extraData);

	m_pEWrapper->tickNews(tickerId, timeStampMs, providerCode, articleId, headline, extraData);
...
const char* EDecoder::processTickNewsMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	long long timeStampMs = tickNewsProto.has_timestamp() ? tickNewsProto.timestamp() : 0;
	const std::string& providerCode = tickNewsProto.providercode();
	const std::string& articleId = tickNewsProto.articleid();
	const std::string& headline = tickNewsProto.headline();
	const std::string& extraData = tickNewsProto.extradata();

	m_pEWrapper->tickNews(reqId, timeStampMs, providerCode, articleId, headline, extraData);
...
const char* EDecoder::processNewsProvidersMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	for (int i = 0; i < newsProvidersProto.newsproviders_size(); ++i) {
		...
		newsProvider.providerCode = newsProviderProto.providercode();
		newsProvider.providerName = newsProviderProto.providername();
...
const char* EDecoder::processNewsArticleMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& articleText = newsArticleProto.articletext();
...
const char* EDecoder::processHistoricalNewsMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& time = historicalNewsProto.time();
	const std::string& providerCode = historicalNewsProto.providercode();
	const std::string& articleId = historicalNewsProto.articleid();
	const std::string& headline = historicalNewsProto.headline();
...
const char* EDecoder::processTickReqParamsMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& bboExchange = tickReqParamsProto.bboexchange();
...
const char* EDecoder::processHeadTimestampMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& headTimestamp = headTimestampProto.headtimestamp();
...
const char* EDecoder::processRerouteMktDataReqMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& exchange = rerouteMarketDataRequestProto.exchange();
...
const char* EDecoder::processRerouteMktDepthReqMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& exchange = rerouteMarketDepthRequestProto.exchange();
...
const char* EDecoder::processReplaceFAEndMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& text = replaceFAEndProto.text();
...
const char* EDecoder::processWshEventDataMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& dataJson = wshEventDataProto.datajson();
...
const char* EDecoder::processWshMetaDataMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& dataJson = wshMetaDataProto.datajson();
...
const char* EDecoder::processHistoricalScheduleMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& startDateTime = historicalScheduleProto.startdatetime();
	const std::string& endDateTime = historicalScheduleProto.enddatetime();
	const std::string& timeZone = historicalScheduleProto.timezone();
	...
	for (int i = 0; i < historicalScheduleProto.historicalsessions_size(); i++) {
		...
		historicalSession.startDateTime = sessionProto.startdatetime();
		historicalSession.endDateTime = sessionProto.enddatetime();
		historicalSession.refDate = sessionProto.refdate();
...
const char* EDecoder::processUserInfoMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	const std::string& whiteBrandingId = userInfoProto.whitebrandingid();
...
const char* EDecoder::processCurrentTimeInMillisMsgProtoBuf(const char* ptr, const char* endPtr) {
	...
	long long timeInMillis = currentTimeInMillisProto.has_currenttimeinmillis() ? currentTimeInMillisProto.currenttimeinmillis() : 0;
